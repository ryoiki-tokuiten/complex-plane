...
const exported = [
    '_ce_alloc', '_ce_free', '_ce_abi_version', '_ce_evaluate_points', '_ce_evaluate_algebraic_points',
    '_ce_pow_points', '_ce_zeta_points', '_ce_evaluate_sheets', '_ce_continuation_sheets',
